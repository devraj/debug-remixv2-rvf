 ...
 */
import type { LearnTOCUnitVideoAbridgedResponse } from './learnTOCUnitVideoAbridgedResponse';

export interface LearnTOCTeachableUnitAbridgedResponse {
  createdAt: string;
  updatedAt: string;
  id: string;
  number: number;
  title: string;
  unitVideos: LearnTOCUnitVideoAbridgedResponse[];
}
