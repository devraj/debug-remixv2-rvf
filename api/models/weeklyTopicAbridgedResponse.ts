 ...
 */
import type { WeeklyTopicAbridgedResponseChallengeTitle } from './weeklyTopicAbridgedResponseChallengeTitle';

export interface WeeklyTopicAbridgedResponse {
  id: string;
  number: number;
  title: string;
  challengeTitle: WeeklyTopicAbridgedResponseChallengeTitle;
  thumbnailUrl: string;
}
